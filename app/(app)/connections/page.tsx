...
const CHANNELS = [
  ...
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    desc: 'Auto-post issue summaries to your LinkedIn page or personal profile when an issue is published',
    status: 'coming_soon',
    detail: 'LinkedIn API v2 · OAuth 2.0 · w_member_social scope',
    color: 'text-[#0077B5]',
    bg: 'bg-[#0077B5]/10',
    icon: LinkedInIcon,
  },
...
const COMING_SOON = ['X / Twitter', 'Slack']
